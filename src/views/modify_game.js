exports.HTML = (game, category, language) => {
    return `
    <!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            <div class="cart-title">
                                <h2>Modify ${game[0].name} </h2>
                            </div>
                            <form action="/update_game" method="post">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label>Game Name</label>
                                        <input type="text" class="form-control" name="name" id="game_name" value="${game[0].name}" readonly required>
                                    </div>
                                    ...
                                    <div class="cart-btn mt-100">
                                        <input type="submit" value="Modify" class="btn amado-btn">
                                    </div>
                                </div>
                            </form>
                        </div>
